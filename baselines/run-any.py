...
def parse_args():
    ...
    parser.add_argument('--init_method', type=str, default='Normal', help="init_method")
...
if args.method == 'LightPopMix':
    if args.dataset in ['yelp2018', 'gowalla', 'amazon-book']:
        ...
        os.system(f'python main.py --project {project} --name {args.method} --notes _ --tag LightPopMix --group ours --job_type {args.dataset} --model LightGCN --loss Adaptive --augment No --lambda1 {lambda1} --temp_tau {temp_tau} --centroid_mode {centroid}\
                    --sampling uii --dataset {args.dataset} --cuda {args.device} --comment _ --if_valid {args.valid} --if_visual {args.visual} --visual_epoch 5 --seed {args.seed} --init_method {init_method} --c {args.c}')
    ...
    if args.dataset in ['yelp2018', 'gowalla', 'amazon-book', 'last-fm', 'ifashion', 'Tencent']:
        os.system(f'python main.py --project {project} --name {args.method} --notes _ --tag {args.method} --group baseline --job_type {args.dataset} --model LightGCN --loss BPR --dataset {args.dataset} --cuda {args.device} --comment _ --if_valid {args.valid} --if_visual {args.visual} --visual_epoch 5 --seed {args.seed} --init_method {init_method} --c {args.c}')

elif args.method == 'GTN':
    #HyperParms: None
    if args.dataset in ['yelp2018', 'gowalla', 'amazon-book', 'last-fm', 'ifashion', 'Tencent']:
        os.system(f'python main.py --project {project} --name {args.method} --notes _ --tag {args.method} --group baseline --job_type {args.dataset} --model GTN --loss BPR --dataset {args.dataset} --cuda {args.device} --comment _ --if_valid {args.valid} --if_visual {args.visual} --visual_epoch 5 --seed {args.seed} --init_method {init_method} --c {args.c}')
    ...
    if args.dataset in ['yelp2018', 'gowalla', 'amazon-book', 'last-fm', 'ifashion', 'Tencent']:
        ...
        os.system(f'python main.py --project {project} --name {args.method} --notes _ --tag SGL --group baseline --job_type {args.dataset} --model SGL --loss BPR_Contrast --augment ED --lambda1 {lambda1} --p_drop {p_drop} --temp_tau {temp_tau} \
                    --dataset {args.dataset} --cuda {args.device} --comment _ --if_valid {args.valid} --if_visual {args.visual} --visual_epoch 1 --seed {args.seed} --init_method {init_method} --c {args.c}')
    ...
    if args.dataset in ['yelp2018', 'gowalla', 'amazon-book', 'last-fm', 'ifashion', 'Tencent']:
        ...
        os.system(f'python main.py --project {project} --name {args.method} --notes _ --tag {args.method} --group baseline --job_type {args.dataset} --model LightGCN --loss PDA --augment No --pop_gamma {pop_gamma} \
                    --dataset {args.dataset} --cuda {args.device} --comment _ --if_valid {args.valid} --if_visual {args.visual} --visual_epoch 4 --seed {args.seed} --init_method {init_method} --c {args.c}')
    ...
    if args.dataset in ['yelp2018', 'gowalla', 'amazon-book', 'last-fm', 'ifashion', 'Tencent']:
        os.system(f'python main.py --project {project} --name {args.method} --notes _ --tag {args.method} --group baseline --job_type {args.dataset} --model LightGCN --loss BC --augment No --lambda1 {lambda1} --temp_tau_pop 0.1 --temp_tau {temp_tau} \
                    --dataset {args.dataset} --cuda {args.device} --comment _ --if_valid {args.valid} --if_visual {args.visual} --visual_epoch 5 --seed {args.seed} --init_method {init_method} --c {args.c}')
    ...
    if args.dataset in ['yelp2018', 'gowalla', 'amazon-book']:
        ...
        os.system(f'python main.py --project {project} --name {args.method} --notes Ablation_wo_projectors --tag Ablation_proj --group ours --job_type {args.dataset} --model LightGCN --loss Adaptive --augment No --lambda1 {lambda1} --temp_tau {temp_tau} --centroid_mode {centroid}\
                    --sampling uii --projector wo --dataset {args.dataset} --cuda {args.device} --comment _ --if_valid {args.valid} --if_visual {args.visual} --visual_epoch 5 --seed {args.seed} --init_method {init_method} --c {args.c}')
