...
#baselines  #python vis.py --device 0 --method LightGCN
#baselines  #python vis.py --device 0 --method SimGCL
#baselines  #python vis.py --device 0 --method BC
#baselines  #python vis.py --device 0 --method Adaloss
#code       #python vis.py --device 0 --method LightPopMix